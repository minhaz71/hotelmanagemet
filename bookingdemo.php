                            ...
                            <div class="submit-form">
                                ...
                                <form id="form-submit" action="" method="get">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset>
                                                <label for="from">Room Type</label>

                                                <?php 
                           if (isset ($_POST['club']))
                           {?>
                                   <input  class='form-control input-field' type="text" value='club'  name="Type" readonly><br>
                        <?php   }
                            else if(isset ($_POST['classic']))
                                {?>
                                   <input  class='form-control input-field' type="text" value='classic' name="Type"  readonly><br>
                        <?php   }
                            else if(isset ($_POST['superior'])){?>
                                   <input  class='form-control input-field' type="text" value='superior'  name="Type"  readonly><br>
                        <?php   }
                            else if(isset ($_POST['family'])){?>
                                   <input  class='form-control input-field' type="text" value='family'  name="Type"  readonly><br>
                        <?php   }
                            else if(isset ($_POST['presidential'])){?>
                                   <input  class='form-control input-field' type="text" value='presidential'  name="Type" readonly><br>
                        <?php   }
                            else if(isset ($_POST['bachelor'])){?>
                                   <input  class='form-control input-field' type="text" value='bachelor'  name="Type" readonly><br>
                        <?php   }
                            else if(isset ($_POST['luxury'])){?>
                                   <input  class='form-control input-field' type="text" value='luxury'  name="Type" readonly><br>
                        <?php   }
                            else if(isset ($_POST['del']))
                                {?>
                                   <input  class='form-control input-field' type="text" value='delux'  name="Type"  readonly><br>
                        <?php   }
                            else if(isset ($_POST['super'])){?>
                                   <input  class='form-control input-field' type="text" value='superdelux' name="Type" readonly><br>
                        <?php   } else {  ?>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                <label for="to">Number of guest :</label>
                                                <select required onchange='this.form.()' for ='noguest' name='NoGuest'>
                         ...
                         <?php 
                             if (isset ($_POST['club']))
                             {?>
                                     <input id ='deparure' class='form-control input-field' type="text" value='7600' readonly><br>
                          <?php   }
                              else if(isset ($_POST['classic']))
                                  {?>
                                     <input   id ='deparure'  class='form-control input-field' type="text" value='4500'  readonly><br>
                          <?php   }
                              else if(isset ($_POST['superior'])){?>
                                     <input   id ='deparure'  class='form-control input-field' type="text" value='5000'    readonly><br>
                          <?php   }
                              else if(isset ($_POST['family'])){?>
                                     <input   id ='deparure'  class='form-control input-field' type="text" value='7800'   readonly><br>
                          <?php   }
                              else if(isset ($_POST['presidential'])){?>
                                     <input   id ='deparure'  class='form-control input-field' type="text" value='6500'  readonly><br>
                          <?php   }
                              else if(isset ($_POST['bachelor'])){?>
                                     <input   id ='deparure'  class='form-control input-field' type="text" value='4000'  readonly><br>
                          <?php   }
                              else if(isset ($_POST['luxury'])){?>
                                     <input   id ='deparure'  class='  form-control input-field' type="text" value='9500' readonly><br>
                          <?php   }
                              else if(isset ($_POST['del']))
                                  {?>
                                     <input  id ='deparure'   class=' input-field form-control' type="text" value='5500' readonly><br>
                          <?php   }
                              else if(isset ($_POST['super'])){?>
                                      <input name="deparure" type="text" class="form-control date" id="deparure" placeholder="Select date..." > <br>
                          <?php   } else { ?> <input name="deparure" type="text" class="form-control" value="8000" id="deparure" placeholder="Select date..." > <br> <?php } ?>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                <label for="return">Check In</label>
